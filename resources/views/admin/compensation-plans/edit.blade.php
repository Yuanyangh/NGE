        ...
        <form method="POST" action="{{ route('admin.compensation-plans.update', $plan->id) }}">
                    ...
                    <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                        ...
                        <div>
                            <x-admin.select
                                ...
                                label="Currency"
                                :value="old('config.plan.currency', $extracted['plan']['currency'])"
                                required
                        ...
                        <div>
                            <x-admin.select
                                ...
                                :value="old('config.plan.calculation_frequency', $extracted['plan']['calculation_frequency'])"
                                required
                        ...
                        <div>
                            <x-admin.select
                                ...
                                :value="old('config.plan.credit_frequency', $extracted['plan']['credit_frequency'])"
                                required
                        ...
                        <div>
                            <x-admin.select
                                ...
                                label="Timezone"
                                :value="old('config.plan.timezone', $extracted['plan']['timezone'])"
                                required
                    ...
                    <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                        ...
                        <div>
                            <x-admin.input
                                ...
                                type="number"
                                :value="old('config.qualification.rolling_days', $extracted['qualification']['rolling_days'])"
                                required
                                placeholder="30"
                            />
                        ...
                        <div>
                            <x-admin.input
                                ...
                                type="number"
                                step="1"
                                :value="old('config.qualification.active_customer_min_order_xp', $extracted['qualification']['active_customer_min_order_xp'])"
                                required
                                placeholder="20"
                            />
                        ...
                        <div class="sm:col-span-2">
                            <x-admin.select
                                ...
                                :value="old('config.qualification.active_customer_threshold_type', $extracted['qualification']['active_customer_threshold_type'])"
                                required
            ...
            <div class="mt-6">
                <x-admin.form-section title="Affiliate Commission" description="Configure how affiliates earn commissions from their directly referred customers' purchases.">
                    ...
                    <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                        <div>
                            <x-admin.select
                                ...
                                label="Payout Method"
                                :value="old('config.affiliate_commission.payout_method', $extracted['affiliate_commission']['payout_method'])"
                                required
                    ...
                    <div class="mt-5 space-y-4">
                        <div class="rounded-lg border border-slate-200 bg-slate-50 px-5 py-4 dark:border-slate-700 dark:bg-slate-800/50">
                            <x-admin.toggle
                                ...
                                :checked="old('config.affiliate_commission.self_purchase_earns_commission', $extracted['affiliate_commission']['self_purchase_earns_commission'])"
                            />
                        ...
                        <div class="rounded-lg border border-slate-200 bg-slate-50 px-5 py-4 dark:border-slate-700 dark:bg-slate-800/50">
                            <x-admin.toggle
                                ...
                                :checked="old('config.affiliate_commission.includes_smartship', $extracted['affiliate_commission']['includes_smartship'])"
                            />
                    ...
                    @php
                        $affiliateTiersJson = old('config.affiliate_commission.tiers', $extracted['affiliate_commission']['tiers']);
                    @endphp
                    <div class="mt-6"
                        x-data="{
                            tiers: {{ Js::from($affiliateTiersJson) }},
                            addTier() {
            ...
            <div class="mt-6">
                <x-admin.form-section title="Viral (Network) Commission" description="Configure how affiliates earn commissions from their extended network (downline) activity.">
                    ...
                    <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                        <div class="sm:col-span-2">
                            <x-admin.select
                                ...
                                :value="old('config.viral_commission.tree', $extracted['viral_commission']['tree'])"
                                required
                    ...
                    @php
                        $viralTiersJson = old('config.viral_commission.tiers', $extracted['viral_commission']['tiers']);
                    @endphp
                    <div class="mt-6"
                        x-data="{
                            tiers: {{ Js::from($viralTiersJson) }},
                            addTier() {
                        ...
                        <div class="overflow-x-auto rounded-lg border border-slate-200 dark:border-slate-700">
                            <table class="min-w-full divide-y divide-slate-200 dark:divide-slate-700">
                                <thead class="bg-slate-50 dark:bg-slate-800">
                                    <tr>
                                        <th class="px-4 py-3 text-left text-xs font-semibold uppercase tracking-wide text-slate-500 dark:text-slate-400">Tier</th>
                                        <th class="px-4 py-3 text-left text-xs font-semibold uppercase tracking-wide text-slate-500 dark:text-slate-400">Min Active Customers</th>
                                        <th class="px-4 py-3 text-left text-xs font-semibold uppercase tracking-wide text-slate-500 dark:text-slate-400">Min Referred Volume ($)</th>
                                        <th class="px-4 py-3 text-left text-xs font-semibold uppercase tracking-wide text-slate-500 dark:text-slate-400">
                                            Min QVV ($)
                                            <span class="block font-normal normal-case text-slate-400 dark:text-slate-500">Qualifying Viral Volume</span>
                                        </th>
                                        <th class="px-4 py-3 text-left text-xs font-semibold uppercase tracking-wide text-slate-500 dark:text-slate-400">Daily Reward ($)</th>
                                        <th class="px-4 py-3 text-left text-xs font-semibold uppercase tracking-wide text-slate-500 dark:text-slate-400">
                                            <span class="sr-only">Actions</span>
                                        </th>
                                    </tr>
                    ...
                    <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                        ...
                        <div>
                            ...
                            <div class="relative mt-1.5">
                                <input
                                    ...
                                    value="{{ old('config.caps.total_payout_cap_percent', $extracted['caps']['total_payout_cap_percent']) }}"
                                    min="0"
                                    max="100"
                                    step="0.01"
                                    required
                        ...
                        <div>
                            <x-admin.select
                                ...
                                :value="old('config.caps.total_payout_cap_enforcement', $extracted['caps']['total_payout_cap_enforcement'])"
                                required
                        ...
                        <div>
                            ...
                            <div class="relative mt-1.5">
                                <input
                                    ...
                                    value="{{ old('config.caps.viral_cap_percent', $extracted['caps']['viral_cap_percent']) }}"
                                    min="0"
                                    max="100"
                                    step="0.01"
                                    required
                        ...
                        <div>
                            <x-admin.select
                                ...
                                :value="old('config.caps.viral_cap_enforcement', $extracted['caps']['viral_cap_enforcement'])"
                                required
                        ...
                        <div class="sm:col-span-2">
                            <x-admin.select
                                ...
                                :value="old('config.caps.enforcement_order', $extracted['caps']['enforcement_order'])"
                                required
                    ...
                    <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                        ...
                        <div>
                            <x-admin.select
                                ...
                                label="Credit Timing"
                                :value="old('config.wallet.credit_timing', $extracted['wallet']['credit_timing'])"
                                required
                                :options="['weekly' => 'Weekly', 'monthly' => 'Monthly']"
                            />
                        ...
                        <div>
                            <x-admin.input
                                ...
                                type="number"
                                step="1"
                                :value="old('config.wallet.release_delay_days', $extracted['wallet']['release_delay_days'])"
                                required
                                placeholder="0"
                            />
                        ...
                        <div>
                            ...
                            <div class="relative mt-1.5">
                                ...
                                <input
                                    ...
                                    value="{{ old('config.wallet.minimum_withdrawal', $extracted['wallet']['minimum_withdrawal']) }}"
                                    min="0"
                                    step="0.01"
                                    required
                                    class="block w-full rounded-lg border border-slate-300 bg-white py-2 pl-7 pr-3 text-sm text-slate-900 shadow-sm placeholder:text-slate-400 focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500 dark:border-slate-600 dark:bg-slate-800 dark:text-white dark:focus:border-indigo-400 dark:focus:ring-indigo-400"
                        ...
                        <div>
                            <x-admin.input
                                ...
                                type="number"
                                step="1"
                                :value="old('config.wallet.clawback_window_days', $extracted['wallet']['clawback_window_days'])"
                                required
                                placeholder="30"
                            />
