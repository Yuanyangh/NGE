                    ...
                    <tr class="hover:bg-slate-50/50 dark:hover:bg-slate-800/50">
                        ...
                        <td class="whitespace-nowrap px-4 py-3 text-right text-sm">
                            <div class="flex items-center justify-end gap-1">
                                @if ($plan->company_id)
                                    <a href="{{ route('admin.companies.plans.bonus-types.index', [$plan->company_id, $plan->id]) }}" class="inline-flex size-8 items-center justify-center rounded-lg text-slate-400 transition-colors hover:bg-emerald-50 hover:text-emerald-600 dark:hover:bg-emerald-900/20 dark:hover:text-emerald-400" title="Manage Bonus Types">
