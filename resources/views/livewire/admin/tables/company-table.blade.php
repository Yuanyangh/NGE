    ...
    @else
        <x-admin.data-table>
            <x-slot:header>
                ...
                <th class="px-4 py-3 text-left text-xs font-medium uppercase tracking-wider text-slate-500 dark:text-slate-400">Slug</th>
                ...
                @foreach ($companies as $company)
                    <tr class="hover:bg-slate-50/50 dark:hover:bg-slate-800/50">
                        ...
                        <td class="whitespace-nowrap px-4 py-3 text-sm text-slate-500 dark:text-slate-400">
                            <code class="rounded bg-slate-100 px-1.5 py-0.5 text-xs dark:bg-slate-800">{{ $company->slug }}</code>
                        </td>
                        ...
                        <td class="whitespace-nowrap px-4 py-3 text-right text-sm">
                            <div class="flex items-center justify-end gap-1">
                                <a href="{{ route('admin.companies.edit', $company) }}" class="inline-flex size-8 items-center justify-center rounded-lg text-slate-400 transition-colors hover:bg-indigo-50 hover:text-indigo-600 dark:hover:bg-indigo-900/20 dark:hover:text-indigo-400" title="Edit">
