{{-- Shared date filter used by all reports --}}
<div class="no-print rounded-xl border border-slate-200 bg-white p-5 dark:border-slate-800 dark:bg-slate-900">
    <form wire:submit="regenerate" class="flex flex-col gap-4 sm:flex-row sm:items-end">
        <div class="flex-1">
            <label class="block text-xs font-medium uppercase tracking-wider text-slate-500 dark:text-slate-400">From</label>
        ...
        <div class="flex-1">
            <label class="block text-xs font-medium uppercase tracking-wider text-slate-500 dark:text-slate-400">To</label>
